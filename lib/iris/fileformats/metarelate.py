...
STASH_TO_CF = {
	...
	"m01s01i208" : CFname(cfname="toa_outgoing_shortwave_flux", unit="W m-2"),
	...
	"m01s01i232" : CFname(cfname="tendency_of_air_temperature_due_to_shortwave_heating", unit=""),
	"m01s01i233" : CFname(cfname="tendency_of_air_temperature_due_to_shortwave_heating_assuming_clear_sky", unit=""),
	"m01s01i235" : CFname(cfname="surface_downwelling_shortwave_flux_in_air", unit="W m-2"),
	"m01s01i237" : CFname(cfname="net_downward_shortwave_flux_in_air", unit="W m-2"),
	"m01s01i238" : CFname(cfname="tropopause_upwelling_shortwave_flux", unit=""),
	"m01s01i242" : CFname(cfname="large_scale_cloud_liquid_water_content_of_atmosphere_layer", unit=""),
	...
	"m01s02i207" : CFname(cfname="surface_downwelling_longwave_flux_in_air", unit="W m-2"),
	"m01s02i208" : CFname(cfname="surface_downwelling_longwave_flux_in_air_assuming_clear_sky", unit="W m-2"),
	"m01s02i232" : CFname(cfname="tendency_of_air_temperature_due_to_longwave_heating", unit="K s-1"),
	"m01s02i233" : CFname(cfname="tendency_of_air_temperature_due_to_longwave_heating_assuming_clear_sky", unit=""),
	"m01s02i237" : CFname(cfname="tropopause_net_downward_longwave_flux", unit=""),
	"m01s02i238" : CFname(cfname="tropopause_downwelling_longwave_flux", unit=""),
	...
	"m01s03i202" : CFname(cfname="downward_heat_flux_in_soil", unit=""),
	"m01s03i217" : CFname(cfname="surface_upward_sensible_heat_flux", unit="W m-2"),
	"m01s03i219" : CFname(cfname="surface_downward_eastward_stress", unit="Pa"),
	"m01s03i220" : CFname(cfname="surface_downward_northward_stress", unit="Pa"),
	...
	"m01s03i225" : CFname(cfname="eastward_wind", unit="m s-1"),
	"m01s03i226" : CFname(cfname="northward_wind", unit="m s-1"),
	...
	"m01s03i234" : CFname(cfname="surface_upward_latent_heat_flux", unit="W m-2"),
	"m01s03i236" : CFname(cfname="air_temperature", unit="K"),
	"m01s03i237" : CFname(cfname="specific_humidity", unit="1"),
	"m01s03i238" : CFname(cfname="soil_temperature", unit="K"),
	"m01s03i245" : CFname(cfname="relative_humidity", unit="%"),
	"m01s03i249" : CFname(cfname="wind_speed", unit="m s-1"),
	"m01s03i258" : CFname(cfname="surface_snow_melt_heat_flux", unit="W m-2"),
	"m01s03i261" : CFname(cfname="gross_primary_productivity_of_carbon", unit="kg m-2 s-1"),
	"m01s03i262" : CFname(cfname="net_primary_productivity_of_carbon", unit="kg m-2 s-1"),
	"m01s03i295" : CFname(cfname="surface_snow_area_fraction_where_land", unit="%"),
	"m01s03i298" : CFname(cfname="water_sublimation_flux", unit="kg m-2 s-1"),
	...
	"m01s05i205" : CFname(cfname="convective_rainfall_rate", unit="kg m-2 s-1"),
	"m01s05i206" : CFname(cfname="convective_snowfall_flux", unit="kg m-2 s-1"),
	"m01s05i209" : CFname(cfname="air_temperature", unit="K"),
	"m01s05i212" : CFname(cfname="convective_cloud_area_fraction_of_atmosphere_layer", unit=""),
	"m01s05i213" : CFname(cfname="mass_fraction_of_convective_cloud_liquid_water_in_air", unit="1"),
	"m01s05i214" : CFname(cfname="rainfall_flux", unit="kg m-2 s-1"),
	"m01s05i215" : CFname(cfname="snowfall_flux", unit="kg m-2 s-1"),
	"m01s05i216" : CFname(cfname="precipitation_flux", unit="kg m-2 s-1"),
	"m01s05i233" : CFname(cfname="mass_fraction_of_convective_cloud_liquid_water_in_air", unit="1"),
	...
	"m01s08i202" : CFname(cfname="surface_snow_melt_flux_where_land", unit="kg m-2 s-1"),
	"m01s08i204" : CFname(cfname="surface_runoff_amount", unit="kg m-2"),
	"m01s08i205" : CFname(cfname="subsurface_runoff_amount", unit="kg m-2"),
	"m01s08i208" : CFname(cfname="soil_moisture_content", unit=""),
	"m01s08i209" : CFname(cfname="canopy_water_amount", unit=""),
	"m01s08i223" : CFname(cfname="moisture_content_of_soil_layer", unit="kg m-2"),
	"m01s08i225" : CFname(cfname="soil_temperature", unit="K"),
	"m01s08i229" : CFname(cfname="mass_fraction_of_unfrozen_water_in_soil_moisture", unit=""),
	"m01s08i230" : CFname(cfname="mass_fraction_of_frozen_water_in_soil_moisture", unit=""),
	"m01s08i231" : CFname(cfname="surface_snow_melt_flux_where_land", unit="kg m-2 s-1"),
	...
	"m01s12i201" : CFname(cfname="lagrangian_tendency_of_air_pressure", unit="Pa s-1"),
	...
	"m01s15i219" : CFname(cfname="square_of_air_temperature", unit=""),
	"m01s15i220" : CFname(cfname="square_of_eastward_wind", unit=""),
	"m01s15i221" : CFname(cfname="square_of_northward_wind", unit=""),
	"m01s15i222" : CFname(cfname="lagrangian_tendency_of_air_pressure", unit="Pa s-1"),
	"m01s15i223" : CFname(cfname="product_of_omega_and_air_temperature", unit=""),
	"m01s15i224" : CFname(cfname="product_of_eastward_wind_and_omega", unit=""),
	"m01s15i225" : CFname(cfname="product_of_northward_wind_and_omega", unit=""),
	"m01s15i226" : CFname(cfname="specific_humidity", unit=""),
	"m01s15i227" : CFname(cfname="product_of_eastward_wind_and_specific_humidity", unit=""),
	"m01s15i228" : CFname(cfname="product_of_northward_wind_and_specific_humidity", unit=""),
	"m01s15i235" : CFname(cfname="product_of_omega_and_specific_humidity", unit=""),
	"m01s15i238" : CFname(cfname="geopotential_height", unit=""),
	"m01s15i239" : CFname(cfname="product_of_eastward_wind_and_geopotential_height", unit=""),
	"m01s15i240" : CFname(cfname="product_of_northward_wind_and_geopotential_height", unit=""),
	...
	"m01s16i204" : CFname(cfname="relative_humidity", unit="%"),
	"m01s16i222" : CFname(cfname="air_pressure_at_sea_level", unit="Pa"),
	"m01s16i224" : CFname(cfname="square_of_height", unit=""),
	...
	"m01s30i310" : CFname(cfname="northward_transformed_eulerian_mean_air_velocity", unit="MKS"),
	"m01s30i311" : CFname(cfname="northward_transformed_eulerian_mean_air_velocity", unit="MKS"),
	"m01s30i312" : CFname(cfname="northward_eliassen_palm_flux_in_air", unit="MKS"),
	"m01s30i313" : CFname(cfname="upward_eliassen_palm_flux_in_air", unit="MKS"),
	"m01s30i314" : CFname(cfname="tendency_of_eastward_wind_due_to_eliassen_palm_flux_divergence", unit="MKS"),
	...
	"m01s33i001" : CFname(cfname="mole_fraction_of_ozone_in_air", unit="mole mole-1"),
	"m01s33i004" : CFname(cfname="mole_fraction_of_nitrogen_trioxide_in_air", unit="mole mole-1"),
	"m01s33i005" : CFname(cfname="mole_fraction_of_dinitrogen_pentoxide_in_air", unit="mole mole-1"),
	"m01s33i006" : CFname(cfname="mole_fraction_of_peroxynitric_acid_in_air", unit="mole mole-1"),
	"m01s33i007" : CFname(cfname="mole_fraction_of_chlorine_nitrate_in_air", unit="mole mole-1"),
	"m01s33i009" : CFname(cfname="mole_fraction_of_methane_in_air", unit="mole mole-1"),
	...
	"m01s33i270" : CFname(cfname="age_of_stratospheric_air", unit="Years"),
	...
	"m03s00i177" : CFname(cfname="prescribed_heat_flux_into_slab_ocean", unit="W m-2"),
	"m03s00i337" : CFname(cfname="downward_heat_flux_in_soil", unit="W m-2"),
	"m03s00i392" : CFname(cfname="surface_downward_eastward_stress", unit="Pa"),
	"m03s00i394" : CFname(cfname="surface_downward_eastward_stress", unit="Pa"),
	"m06s00i101" : CFname(cfname="upward_eastward_momentum_flux_in_air_due_to_nonorographic_eastward_gravity_waves", unit="MKS"),
	"m06s00i103" : CFname(cfname="upward_eastward_momentum_flux_in_air_due_to_nonorographic_westward_gravity_waves", unit="MKS"),
	"m06s00i201" : CFname(cfname="upward_eastward_momentum_flux_in_air_due_to_orographic_gravity_waves", unit="MKS"),
	"m06s00i207" : CFname(cfname="tendency_of_eastward_wind_due_to_orographic_gravity_wave_drag", unit="MKS"),
	"m15s00i243" : CFname(cfname="eastward_wind", unit="m s-1"),
	"m15s00i244" : CFname(cfname="northward_wind", unit="m s-1"),
}
...
GRIB2P_TO_CF = {
	G2param(edition=2, discipline=0, category=0, number=0) : CFname(cfname="air_temperature", unit="kelvin"),
	G2param(edition=2, discipline=0, category=0, number=2) : CFname(cfname="potential_temperature", unit="K"),
	G2param(edition=2, discipline=0, category=1, number=0) : CFname(cfname="specific_humidity", unit="kg kg-1"),
	G2param(edition=2, discipline=0, category=1, number=1) : CFname(cfname="relative_humidity", unit="%"),
	G2param(edition=2, discipline=0, category=1, number=13) : CFname(cfname="water_equivalent_of_accumulated_snow_depth", unit="kg m-2"),
	G2param(edition=2, discipline=0, category=1, number=22) : CFname(cfname="cloud_mixing_ratio", unit="kg kg-1"),
	G2param(edition=2, discipline=0, category=1, number=3) : CFname(cfname="precipitable_water", unit="kg m-2"),
	G2param(edition=2, discipline=0, category=14, number=0) : CFname(cfname="total_ozone", unit="Dobson"),
	G2param(edition=2, discipline=0, category=2, number=1) : CFname(cfname="wind_speed", unit="m s-1"),
	G2param(edition=2, discipline=0, category=2, number=10) : CFname(cfname="absolute_vorticity", unit="s-1"),
	G2param(edition=2, discipline=0, category=2, number=2) : CFname(cfname="x_wind", unit="m s-1"),
	G2param(edition=2, discipline=0, category=2, number=3) : CFname(cfname="y_wind", unit="m s-1"),
	G2param(edition=2, discipline=0, category=2, number=8) : CFname(cfname="vertical_velocity_(pressure)", unit="Pa s-1"),
	G2param(edition=2, discipline=0, category=3, number=0) : CFname(cfname="pressure", unit="Pa"),
	G2param(edition=2, discipline=0, category=3, number=1) : CFname(cfname="pressure_reduced_to_msl", unit="Pa"),
	G2param(edition=2, discipline=0, category=3, number=3) : CFname(cfname="icao_standard_atmosphere_reference_height", unit="m"),
	G2param(edition=2, discipline=0, category=3, number=5) : CFname(cfname="geopotential_height", unit="gpm"),
	G2param(edition=2, discipline=0, category=3, number=9) : CFname(cfname="geopotential_height_anomaly", unit="gpm"),
	G2param(edition=2, discipline=0, category=6, number=1) : CFname(cfname="total_cloud_cover", unit="%"),
	G2param(edition=2, discipline=0, category=6, number=6) : CFname(cfname="cloud_water", unit="kg m-2"),
	G2param(edition=2, discipline=0, category=7, number=6) : CFname(cfname="convective_available_potential_energy", unit="J kg-1"),
	G2param(edition=2, discipline=0, category=7, number=7) : CFname(cfname="convective_inhibition", unit="J kg-1"),
	G2param(edition=2, discipline=0, category=7, number=8) : CFname(cfname="storm_relative_helicity", unit="J kg-1"),
	G2param(edition=2, discipline=2, category=0, number=0) : CFname(cfname="land_cover", unit="proportion"),
}
