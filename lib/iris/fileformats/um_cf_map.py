...
STASH_GRID_EN_ALIGN_TO_CF = {
    'm01s00i002': CFName('eastward_wind', None, 'm s-1'),
    'm01s00i003': CFName('northward_wind', None, 'm s-1'),
    ...
    'm01s03i209': CFName('eastward_wind', None, 'm s-1'),
    'm01s03i210': CFName('northward_wind', None, 'm s-1'),
    ...
    'm01s15i212': CFName('eastward_wind', None, 'm s-1'),
    'm01s15i213': CFName('northward_wind', None, 'm s-1'),
...
STASH_GRID_EN_DIVERGE_TO_CF = {
    ...
    'm01s00i028': CFName('surface_x_sea_water_velocity', None, 'm s-1'),
    'm01s00i029': CFName('surface_y_sea_water_velocity', None, 'm s-1'),
    'm01s00i269': CFName('surface_x_sea_water_velocity', None, 'm s-1'),
    'm01s00i270': CFName('surface_y_sea_water_velocity', None, 'm s-1'),
    'm01s03i209': CFName('x_wind', None, 'm s-1'),
    'm01s03i210': CFName('y_wind', None, 'm s-1'),
    'm01s03i219': CFName('surface_downward_x_stress', None, 'Pa'),
    'm01s03i220': CFName('surface_downward_y_stress', None, 'Pa'),
    'm01s03i225': CFName('x_wind', None, 'm s-1'),
    'm01s03i226': CFName('y_wind', None, 'm s-1'),
    'm01s03i391': CFName('surface_downward_x_stress', None, 'Pa'),
    'm01s03i392': CFName('surface_downward_x_stress', None, 'Pa'),
    'm01s03i393': CFName('surface_downward_y_stress', None, 'Pa'),
    'm01s03i394': CFName('surface_downward_y_stress', None, 'Pa'),
    'm01s03i460': CFName('surface_downward_x_stress', None, 'Pa'),
    'm01s03i461': CFName('surface_downward_y_stress', None, 'Pa'),
    'm01s05i185': CFName('tendency_of_x_wind_due_to_convection', None, 'm s-2'),
    'm01s05i186': CFName('tendency_of_y_wind_due_to_convection', None, 'm s-2'),
    'm01s06i111': CFName('upward_x_momentum_flux_in_air_due_to_nonorographic_x_gravity_waves', None, 'Pa'),
    'm01s06i113': CFName('upward_x_momentum_flux_in_air_due_to_nonorographic_westward_gravity_waves', None, 'Pa'),
    'm01s06i115': CFName('tendency_of_x_wind_due_to_nonorographic_gravity_wave_drag', None, 'm s-2'),
    'm01s06i185': CFName('tendency_of_x_wind_due_to_gravity_wave_drag', None, 'm s-2'),
    'm01s06i186': CFName('tendency_of_y_wind_due_to_gravity_wave_drag', None, 'm s-2'),
    'm01s06i201': CFName('atmosphere_x_stress_due_to_gravity_wave_drag', None, 'Pa'),
    'm01s06i202': CFName('atmosphere_y_stress_due_to_gravity_wave_drag', None, 'Pa'),
    'm01s06i241': CFName('upward_x_momentum_flux_in_air_due_to_orographic_gravity_waves', None, 'Pa'),
    'm01s06i247': CFName('tendency_of_x_wind_due_to_orographic_gravity_wave_drag', None, 'm s-2'),
    'm01s12i185': CFName('tendency_of_x_wind_due_to_advection', None, 'm s-1'),
    'm01s12i186': CFName('tendency_of_y_wind_due_to_advection', None, 'm s-1'),
    'm01s13i002': CFName('x_wind', None, 'm s-1'),
    'm01s13i003': CFName('y_wind', None, 'm s-1'),
    'm01s13i185': CFName('tendency_of_x_wind_due_to_diffusion', None, 'm s-1'),
    'm01s13i186': CFName('tendency_of_y_wind_due_to_diffusion', None, 'm s-1'),
    ...
    'm01s15i220': CFName('square_of_x_wind', None, 'unknown'),
    'm01s15i221': CFName('square_of_y_wind', None, 'unknown'),
    'm01s15i224': CFName('product_of_x_wind_and_omega', None, 'unknown'),
    'm01s15i225': CFName('product_of_y_wind_and_omega', None, 'unknown'),
    'm01s15i227': CFName('product_of_x_wind_and_specific_humidity', None, 'unknown'),
    'm01s15i228': CFName('product_of_y_wind_and_specific_humidity', None, 'unknown'),
    'm01s15i239': CFName('product_of_x_wind_and_geopotential_height', None, 'unknown'),
    'm01s15i240': CFName('product_of_y_wind_and_geopotential_height', None, 'unknown'),
    'm01s15i243': CFName('x_wind', None, 'm s-1'),
    'm01s15i244': CFName('y_wind', None, 'm s-1'),
    'm01s30i185': CFName('tendency_of_x_wind', None, 'm s-1'),
    'm01s30i186': CFName('tendency_of_y_wind', None, 'm s-1'),
    'm01s30i201': CFName('x_wind', None, 'm s-1'),
    'm01s30i202': CFName('y_wind', None, 'm s-1'),
    'm01s30i211': CFName('square_of_x_wind', None, 'm2 s-2'),
    'm01s30i212': CFName('product_of_x_wind_and_y_wind', None, 'm2 s-2'),
    'm01s30i213': CFName('product_of_x_wind_and_upward_air_velocity', None, 'm2 s-2'),
    'm01s30i214': CFName('product_of_x_wind_and_air_temperature', None, 'K m s-1'),
    'm01s30i215': CFName('product_of_x_wind_and_specific_humidity', None, 'm s-1'),
    'm01s30i217': CFName('product_of_x_wind_and_geopotential_height', None, 'm2 s-1'),
    'm01s30i218': CFName('product_of_x_wind_and_omega', None, 'Pa m s-1'),
    'm01s30i222': CFName('square_of_y_wind', None, 'm2 s-2'),
    'm01s30i223': CFName('product_of_y_wind_and_upward_air_velocity', None, 'm2 s-2'),
    'm01s30i224': CFName('product_of_y_wind_and_air_temperature', None, 'K m s-1'),
    'm01s30i225': CFName('product_of_y_wind_and_specific_humidity', None, 'm s-1'),
    'm01s30i227': CFName('product_of_y_wind_and_geopotential_height', None, 'm2 s-1'),
    'm01s30i228': CFName('product_of_y_wind_and_omega', None, 'Pa m s-1'),
    'm01s30i314': CFName('tendency_of_x_wind_due_to_eliassen_palm_flux_divergence', None, 'm s-2'),
    'm02s00i121': CFName('baroclinic_x_sea_water_velocity', None, 'cm s-1'),
    'm02s00i122': CFName('baroclinic_y_sea_water_velocity', None, 'cm s-1'),
    'm02s00i135': CFName('barotropic_x_sea_water_velocity', None, 'cm s-1'),
    'm02s00i136': CFName('barotropic_y_sea_water_velocity', None, 'cm s-1'),
    'm02s00i139': CFName('downward_x_stress_at_sea_ice_base', None, 'Pa'),
    'm02s00i140': CFName('downward_y_stress_at_sea_ice_base', None, 'Pa'),
    'm02s00i148': CFName('x_sea_ice_velocity', None, 'm s-1'),
    'm02s00i149': CFName('y_sea_ice_velocity', None, 'm s-1'),
    'm02s00i150': CFName('surface_downward_x_stress', None, 'Pa'),
    'm02s00i151': CFName('surface_downward_y_stress', None, 'Pa'),
    'm02s30i211': CFName('y_ocean_heat_transport', None, 'PW'),
    'm02s30i212': CFName('y_ocean_salt_transport', None, '1e7kg s-1'),
    'm02s30i320': CFName('x_sea_water_velocity', None, 'cm s-1'),
    'm02s30i321': CFName('y_sea_water_velocity', None, 'cm s-1'),
    'm02s32i209': CFName('x_sea_ice_velocity', None, 'm s-1'),
    'm02s32i210': CFName('y_sea_ice_velocity', None, 'm s-1'),
    'm02s32i219': CFName('downward_x_stress_at_sea_ice_base', None, 'Pa'),
    'm02s32i220': CFName('downward_y_stress_at_sea_ice_base', None, 'Pa'),
    }
