...
STASH_TO_CF = {
	...
	"m01s01i232" : CFname(cfname="tendency_of_air_temperature_due_to_shortwave_heating", unit="unknown"),
	"m01s01i233" : CFname(cfname="tendency_of_air_temperature_due_to_shortwave_heating_assuming_clear_sky", unit="unknown"),
	...
	"m01s01i238" : CFname(cfname="tropopause_upwelling_shortwave_flux", unit="unknown"),
	...
	"m01s02i233" : CFname(cfname="tendency_of_air_temperature_due_to_longwave_heating_assuming_clear_sky", unit="unknown"),
	"m01s02i237" : CFname(cfname="tropopause_net_downward_longwave_flux", unit="unknown"),
	"m01s02i238" : CFname(cfname="tropopause_downwelling_longwave_flux", unit="unknown"),
	...
	"m01s03i202" : CFname(cfname="downward_heat_flux_in_soil", unit="unknown"),
	...
	"m01s08i208" : CFname(cfname="soil_moisture_content", unit="unknown"),
	"m01s08i209" : CFname(cfname="canopy_water_amount", unit="unknown"),
	"m01s08i223" : CFname(cfname="moisture_content_of_soil_layer", unit="kg m-2"),
	"m01s08i225" : CFname(cfname="soil_temperature", unit="K"),
	"m01s08i229" : CFname(cfname="mass_fraction_of_unfrozen_water_in_soil_moisture", unit="unknown"),
	"m01s08i230" : CFname(cfname="mass_fraction_of_frozen_water_in_soil_moisture", unit="unknown"),
	...
	"m01s15i219" : CFname(cfname="square_of_air_temperature", unit="unknown"),
	"m01s15i220" : CFname(cfname="square_of_eastward_wind", unit="unknown"),
	"m01s15i221" : CFname(cfname="square_of_northward_wind", unit="unknown"),
	"m01s15i222" : CFname(cfname="lagrangian_tendency_of_air_pressure", unit="Pa s-1"),
	"m01s15i223" : CFname(cfname="product_of_omega_and_air_temperature", unit="unknown"),
	"m01s15i224" : CFname(cfname="product_of_eastward_wind_and_omega", unit="unknown"),
	"m01s15i225" : CFname(cfname="product_of_northward_wind_and_omega", unit="unknown"),
	"m01s15i226" : CFname(cfname="specific_humidity", unit="unknown"),
	"m01s15i227" : CFname(cfname="product_of_eastward_wind_and_specific_humidity", unit="unknown"),
	"m01s15i228" : CFname(cfname="product_of_northward_wind_and_specific_humidity", unit="unknown"),
	"m01s15i235" : CFname(cfname="product_of_omega_and_specific_humidity", unit="unknown"),
	"m01s15i238" : CFname(cfname="geopotential_height", unit="unknown"),
	"m01s15i239" : CFname(cfname="product_of_eastward_wind_and_geopotential_height", unit="unknown"),
	"m01s15i240" : CFname(cfname="product_of_northward_wind_and_geopotential_height", unit="unknown"),
